...
import org.jetbrains.skia.makeFromBackendRenderTarget
...
class SkikoSurfaceView(context: Context, val layer: SkiaLayer) : GLSurfaceView(context), FrameManager, AndroidSkikoRenderView {
...
private class SkikoSurfaceRender(private val layer: SkiaLayer, private val manager: FrameManager) : GLSurfaceView.Renderer {
    ...
    @Volatile
    private var picture: AndroidPictureHolder? = null
    private var pictureRecorder: PictureRecorder = PictureRecorder()
    private val pictureLock = Any()

    private fun <T : Any> lockPicture(action: (AndroidPictureHolder) -> T): T? {
        ...
        layer.renderDelegate?.let {
            ...
            try {
                ...
                synchronized(pictureLock) {
                    ...
                    this.picture = AndroidPictureHolder(picture)
                }
            }
        }
    }
...
private class AndroidPictureHolder(val instance: Picture)
